...
OpenDQV is a stateless validation service. It has no internal database of submitted records. The contract registry is local to your deployment. Nothing is transmitted to OpenDQV or any third party.
