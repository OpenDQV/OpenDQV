...
OpenDQV is a centralised, stateless data quality validation API for the enterprise.
...
- **Stateless** — No data stored; pure validation service
...
OpenDQV is the source-layer anchor of the modern data quality stack — designed to complement Soda, Great Expectations, dbt, and observability tools, not replace them.
...
| [Roadmap](roadmap.md) | Planned integrations and features by quarter |
