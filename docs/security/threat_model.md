...
This document covers the seven primary attack surfaces identified during the RT30 security review. For each surface, the STRIDE category, current mitigation, residual risk, and recommended control are listed.
