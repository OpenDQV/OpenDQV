...
[![PyPI](https://img.shields.io/badge/pypi-pending%20approval-lightgrey)](https://pypi.org/project/opendqv/)
...
| Role | Intended for | Can validate | Can edit contracts | Can approve | Can manage tokens |
|------|-------------|:---:|:---:|:---:|:---:|
| `validator` | Source systems (Salesforce, SAP, your app) | ✓ | — | — | — |
| `reader` | Read-only consumers, dashboards | — | — | — | — |
