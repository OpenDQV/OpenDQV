...
Covers ACT-003 (RT32) and ACT-011 (RT33).
"""
...
# ── RT33 regression tests ─────────────────────────────────────────────────────

class TestRT33Regressions:
    """ACT-011 — verify all RT33 findings are addressed."""
    ...
    def test_student_entity_fields_infer_correctly(self, tmp_path):
        """RT33 scenario: student fields from Mia's session all infer correctly."""
        checks = {
