"""
Security tests — RT30 remediation verification.
...
class TestContractNameValidation:
    ...
    def test_query_param_name_returns_422(self, client, auth_headers, path, content_type, body, malicious_name):
    ...
    def test_body_query_param_name_returns_422(self, client, auth_headers, path, content_type, body_template, malicious_name):
