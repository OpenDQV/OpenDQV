...
class TestCodeGeneratorHeaders:
    ...
    def test_salesforce_header_present(self):
        code = generate_code(self._rules, "salesforce", contract_name="salesforce_contact", contract_version="1.0")
        assert "// Generated by OpenDQV" in code
        assert "salesforce_contact" in code
        assert "v1.0" in code
        assert "opendqv generate salesforce_contact salesforce" in code
