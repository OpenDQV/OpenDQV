...
class TestGXImportAPI:
    ...
    def test_import_endpoint(self, client, editor_headers):
        suite = _load_sample("gx_suite_sample.json")
        r = client.post("/api/v1/import/gx", json=suite, headers=editor_headers)
    ...
    def test_import_sets_source_and_status(self, client, editor_headers):
    ...
    def test_import_and_save(self, client, editor_headers):
        suite = _load_sample("gx_suite_sample.json")
        r = client.post(
            "/api/v1/import/gx",
            json=suite,
    ...
    def test_roundtrip(self, client, editor_headers):
        # Import a GX suite
        suite = _load_sample("gx_suite_sample.json")
        r1 = client.post(
            "/api/v1/import/gx",
        ...
        try:
            ...
            r2 = client.get(
                "/api/v1/export/gx/customer_contacts", headers=editor_headers
            )
            assert r2.status_code == 200
            exported = r2.json()
