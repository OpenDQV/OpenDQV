...
set RUN1_END=%TIME%
if !RUN1_EXIT! EQU 0 (set RUN1_STATUS=PASS) else (set OVERALL_PASS=0)
echo.
...
set RUN2_END=%TIME%
if !RUN2_EXIT! EQU 0 (set RUN2_STATUS=PASS) else (set OVERALL_PASS=0)
echo.
...
set RUN3_END=%TIME%
if !RUN3_EXIT! EQU 0 (set RUN3_STATUS=PASS) else (set OVERALL_PASS=0)
echo.
