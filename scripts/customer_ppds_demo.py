...
Usage:
    python scripts/customer_ppds_demo.py --customer KFC
    OPENDQV_CUSTOMER=KFC OPENDQV_TOKEN=<token> python scripts/customer_ppds_demo.py
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--customer",
        default=os.environ.get("OPENDQV_CUSTOMER", "KFC"),
        help="Customer name (default: KFC). Add entries to CUSTOMER_MENUS for new customers.",
    )
