...
Scenarios:
  A. Use existing contract (age_compliance_record)
...
# ═══════════════════════════════════════════════════════════════════════
# SCENARIO A — use existing contract: age_compliance_record
# ═══════════════════════════════════════════════════════════════════════
header("SCENARIO A — existing contract: age_compliance_record")
...
check(
    "age_compliance_record in list_contracts()",
...
agent("validate_record(age_compliance_record, minor record) → expect FAIL")
...
agent("validate_record(age_compliance_record, adult verified record) → expect PASS")
adult_record = {
    "user_id": "USR-0089",
    "age": 25,
    "dob": "2000-06-15",
