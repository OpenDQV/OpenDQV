...
VALID_EVENTS = {"validation.failed", "validation.warning", "batch.failed"}
...
VALIDATION_EVENT_SCHEMA = {
    ...
    "event":            {"type": "str",      "required": True,  "example": "validation.failed"},
...
BATCH_EVENT_SCHEMA = {
    "event":            {"type": "str",      "required": True,  "example": "batch.failed"},
